...
from src.generated.automatic_events import (
    AutomaticEvents,
    AutomaticEventsQueryTodaysEvents,
)
from src.generated.base_model import BaseModel
from src.generated.fragments import (
    EventFields,
    EventFieldsLinkedExpenses,
    EventFieldsUser,
)
from src.generated.update_event import UpdateEvent

from src.exceptions import EetlijstException

from src.services.event_attendance.transformers import Attendance, transform_attendance
